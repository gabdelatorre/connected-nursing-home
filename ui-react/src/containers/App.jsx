        ...
        if (!this.state.authUser || !this.state.userDataLoaded) {
            return (
                <Switch>
                    ...
                    <Route path="/registration" render={() => <Registration authUser={this.state.authUser}/>} />
                </Switch>
            )
        }
        // ==========================================================
        ...
        // ==========================================================
            ...
            return (
                <div className="wrapper">
                    ...
                    <Switch>
                        <Route path="/edashboard" render={() => <EmployeeDashboard authUser={this.state.authUser}/>} />
                        <Route path="/nhdashboard" render={() => <NursingHomeDashboard authUser={this.state.authUser}/>} />
                        <Route path="/rdashboard" render={() => <RelativeDashboard authUser={this.state.authUser}/>} />
                    </Switch>
                    </div>
                </div>
            );
